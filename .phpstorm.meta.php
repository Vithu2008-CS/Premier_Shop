...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Retail shop\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Retail shop\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','offers','products.index','products.suggest',
'products.show','cart.index','cart.add','cart.update','cart.remove',
'checkout.index','checkout.applyCoupon','checkout.removeCoupon','checkout.process','orders.index',
'orders.show','profile.edit','profile.update','profile.destroy','admin.dashboard',
'admin.products.index','admin.products.create','admin.products.store','admin.products.show','admin.products.edit',
'admin.products.update','admin.products.destroy','admin.products.regenerateQr','admin.scanner','admin.products.findByQr',
'admin.products.updateStock','admin.coupons.index','admin.coupons.create','admin.coupons.store','admin.coupons.show',
'admin.coupons.edit','admin.coupons.update','admin.coupons.destroy','admin.orders.index','admin.orders.show',
'admin.orders.updateStatus','admin.customers.index','admin.customers.show','admin.customers.destroy','register','register.verify','register.verify.submit','register.resendOtp','login','password.request','password.email','password.reset','password.store',
...
'admin.coupons.create','admin.coupons.edit','admin.coupons.index','admin.customers.index','admin.customers.show',
'admin.dashboard','admin.orders.index','admin.orders.show','admin.products.create','admin.products.edit',
'admin.products.index','admin.products.scanner','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','auth.verify-otp','cart.index',
'checkout.index','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
...
'emails.order-receipt','emails.registration-otp','emails.welcome','home','layouts.admin',
'layouts.app','layouts.guest','layouts.navigation','offers','orders.index',
'orders.show','products.index','products.show','profile.edit','profile.partials.delete-user-form',
...
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.Retail shop.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'MAIL_FROM_NAME','STRIPE_KEY','STRIPE_SECRET','STRIPE_WEBHOOK_SECRET','GOOGLE_MAPS_API_KEY',
'SHOP_ORIGIN_ADDRESS','SHOP_ORIGIN_LAT','SHOP_ORIGIN_LNG','VITE_APP_NAME',);
