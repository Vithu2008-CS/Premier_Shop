                        ...
                        <div class="tab-pane fade {{ $activeTab === 'pricing' ? 'show active' : '' }}" id="pricing-pane" role="tabpanel" tabindex="0">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="form-control d-flex align-items-center" style="display: flex !important; border-radius: 12px !important; height: 38px; padding: 0.375rem 0.75rem;">
                                        <input type="checkbox" name="weight_matters" id="weight_matters" class="custom-premium-checkbox cursor-pointer" style="margin-right: 12px !important;" value="1" {{ old('weight_matters') ? 'checked' : '' }}>
                            ...
                            <div class="row mt-2 border-top pt-3 align-items-end">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-control d-flex align-items-center" style="display: flex !important; border-radius: 12px !important; height: 38px; padding: 0.375rem 0.75rem;">
                                        <input type="checkbox" name="retail_offer" id="retail_offer" class="custom-premium-checkbox cursor-pointer" style="margin-right: 12px !important;" value="1" {{ old('retail_offer') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-control d-flex align-items-center" style="display: flex !important; border-radius: 12px !important; height: 38px; padding: 0.375rem 0.75rem;">
                                        <input type="checkbox" name="is_age_restricted" id="is_age_restricted" class="custom-premium-checkbox cursor-pointer" style="margin-right: 12px !important;" value="1" {{ old('is_age_restricted') ? 'checked' : '' }}>
                        ...
                        <div class="tab-pane fade {{ $activeTab === 'offers' ? 'show active' : '' }}" id="offers-pane" role="tabpanel" tabindex="0">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="form-control d-flex align-items-center" style="display: flex !important; border-radius: 12px !important; height: 38px; padding: 0.375rem 0.75rem;">
                                        <input type="checkbox" name="offer_active" id="offer_active" class="custom-premium-checkbox cursor-pointer" style="margin-right: 12px !important;" value="1" {{ old('offer_active') ? 'checked' : '' }}>
            ...
            const itemHTML = `
                <div class="media-sort-item">
                    ...
                    <div class="media-sort-actions">
                        <button type="button" class="media-btn-circle ${isMain ? 'btn-star-active' : 'btn-star-inactive'}" title="${isMain ? 'Primary Storefront Image (Priority #1)' : 'Set as Primary Storefront Image'}" data-call="setImageAsMain" data-args="[${i}]">
