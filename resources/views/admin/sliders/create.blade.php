...
<div class="container-fluid px-0" style="padding-bottom: 120px;">
    ...
    <div class="row">
        ...
        <div class="col-lg-7 mb-4">
            <form id="slider-create-form" action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data" class="d-flex flex-column gap-4 w-100">
                @csrf
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="fTitle" type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                                       placeholder="e.g. Summer Sale 2026" value="{{ old('title') }}" maxlength="255" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-text small text-muted">Recommended: 1920 × 800 px (≤ 2 MB).</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-text small text-muted">Web address format starting with http/https.</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="form-text small text-muted">Lower priority value = shown first.</div>
                ...
                <div class="card preview-slide-container border-0 p-0 overflow-hidden shadow-sm theme-card-bg">
                    ...
                    <div class="preview-slide" id="previewSlide">
                        ...
                        <div class="preview-slide-content align-center" id="previewContent">
                            <div class="preview-title-lead" id="previewLead">Title Lead</div>
                            <div class="preview-title-accent" id="previewAccent">New Banner</div>
                            <div class="preview-subtitle" id="previewSub">Subtitle preview details</div>
                            <a href="javascript:void(0);" class="preview-cta" id="previewCta">Shop Now →</a>
                        </div>
                    </div>
...
<div class="floating-save-bar d-flex align-items-center justify-content-between px-4 py-3">
    <div class="d-flex align-items-center" style="font-family:'Outfit',sans-serif;gap:8px;">
        ...
        <span class="text-muted text-uppercase d-none d-sm-inline" style="font-size:0.68rem;letter-spacing:0.5px;font-weight:600;white-space:nowrap;">New Banner:</span>
        <span class="font-weight-bold text-nowrap floating-bar-title text-theme-dark-bold" style="font-size:0.85rem; font-family: monospace; letter-spacing: 0.5px;">PENDING</span>
    </div>
    <div class="button-group">
        <a href="{{ route('admin.sliders.index') }}" class="btn btn-outline-light">Cancel</a>
        <button type="submit" form="slider-create-form" class="btn btn-primary">
