...
<div class="container-fluid px-0">
    ...
    <nav class="page-breadcrumb d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
        ...
        <a href="{{ route('admin.delivery-zones.create') }}"
           ...
           style="border-radius:30px !important;font-weight:700;font-family:'Outfit';padding:8px 20px;background:linear-gradient(135deg,#743089,#A45FBF);border:none;box-shadow:0 4px 12px rgba(116, 48, 137,0.25);">
            ...
            @empty
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('admin.delivery-zones.create') }}" class="btn btn-primary btn-sm"
                       style="border-radius:30px !important;font-weight:700;padding:8px 20px;background:linear-gradient(135deg,#743089,#A45FBF);border:none;">
