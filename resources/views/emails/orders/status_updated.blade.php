...
<tr>
    <td style="padding:30px 40px;text-align:center;">
        <div style="display:inline-block;background:#00B894;color:#fff;padding:10px 24px;border-radius:50px;font-size:18px;font-weight:700;text-transform:capitalize;">
